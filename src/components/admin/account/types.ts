...
export const DASHBOARD_SUBMODULES: Record<string, string[]> = {
  ...
  "Creator Management": ["Creator", "Monetization", "Gallery"],
  "Business Management": [],
  Financing: [],
...
export const initialRoles: RoleItem[] = [
  {
    ...
    dashboardPermissions: {
      ...
      Avatar: ["Create", "Read", "Update", "Delete"],
      User: ["Create", "Read", "Update", "Delete"],
      Admin: ["Create", "Read", "Update", "Delete"],
      "Role Management": ["Create", "Read", "Update", "Delete"],
      Creator: ["Create", "Read", "Update", "Delete"],
      Monetization: ["Create", "Read", "Update", "Delete"],
  ...
  },
  {
    ...
    workspacePermissions: ["Creator menu", "Model Postmatic Vision Flash"],
  },
];
