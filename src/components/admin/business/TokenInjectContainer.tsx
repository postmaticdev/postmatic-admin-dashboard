...
const IMAGE_TOKEN_PRODUCT_QUERY_KEY = ["workspace", "businesses", "image-token-product"] as const;
...
export function TokenInjectContainer() {
  ...
  const handleRetry = () => {
    ...
    void tokenProductQuery.refetch();
  };
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              <strong className="text-foreground">
                {formatCurrency(
                  Number(
                    tokenProductQuery.data?.priceAmount ?? tokenProductQuery.data?.amount ?? 0,
                  ),
